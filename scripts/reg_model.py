...
class RegModel:
    ...
    def extract_data(self, bag_name):
        ...
        Args: bag_name (str): The name/path of the rosbag file to extract data from.
        Returns: pandas.DataFrame: A shuffled DataFrame containing 'slope' and 'ang_z' columns.
        """
        ...
        for topic, msg, t in bag.read_messages(topics=[VEH_STEERING_TOPIC]):
            data['ang_z'].append(float(msg.data))
...
if __name__ == '__main__':
    for i in range(4):
        model = RegModel('2023-07-05-15-23-41.bag', model_name=i, gen_img=True)